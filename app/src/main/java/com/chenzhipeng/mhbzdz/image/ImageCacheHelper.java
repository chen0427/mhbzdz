...
public class ImageCacheHelper {
    ...
    public static void clearImageAllCache() {
        ...
        String ImageExternalCatchDir = BaseApplication.getContext().getExternalCacheDir() + ExternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR;
    ...
    public static String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(BaseApplication.getContext().getCacheDir() + "/" + InternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
